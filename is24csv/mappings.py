...
FREI_BIS = {Immobilienart.WAZ: 63, Immobilienart.GARAGE_STELLPLATZ_KAUF: 66}
TEILBAR_AB = {
...
VERMIETET = {Immobilienart.WOHNUNG_KAUF: 76, Immobilienart.HAUS_KAUF: 72}
...
FERIENWOHNUNG = {Immobilienart.WOHNUNG_KAUF: 81, Immobilienart.HAUS_KAUF: 70}
...
PARKPLATZKAUFPREIS = {Immobilienart.WOHNUNG_KAUF: 93, Immobilienart.HAUS_KAUF: 92}
...
MIETEINNAHMEN = {Immobilienart.WOHNUNG_KAUF: 94, Immobilienart.HAUS_KAUF: 93}
...
HEIZKOSTEN = {Immobilienart.WOHNUNG_MIETE: 96, Immobilienart.HAUS_MIETE: 96}
...
TYPES = {
    "objektkategorie_2": partial(parse_enum, Objektkategorie2, preprocess=parse_int),
    ...
    "nutzungsart": partial(
        parse_enum, Nutzungsart, preprocess=parse_int, default=Nutzungsart.WOHNEN
    ),
    "laenge": parse_float,
    ...
    "empfohlene_nutzung": partial(parse_enum, EmpfohleneNutzung, preprocess=parse_int),
    "gesamtflaeche": parse_float,
    "gewerbeflaechen": parse_float,
    "flaeche": parse_float,
    "etage": parse_int,
    "grundstuecksflaeche": parse_float,
    "bebaubar_nach": partial(parse_enum, BebaubarNach, default=BebaubarNach.UNBEKANNT),
    ...
    "objektzustand": partial(
        parse_enum,
        Objektzustand,
        preprocess=parse_int,
        default=Objektzustand.KEINE_ANGABE,
    ),
    "abriss_erforderlich": parse_bool,
    "heizungsart": partial(
        parse_enum, Heizungsart, preprocess=parse_int, default=Heizungsart.KEINE_ANGABE
    ),
    "grz": parse_float,
    "aufzug": parse_bool,
    "gfz": parse_float,
    "bodenbelag": partial(
        parse_enum, Bodenbelag, preprocess=parse_int, default=Bodenbelag.KEINE_ANGABE
    ),
    ...
    "lageart": partial(
        parse_enum, Lageart, preprocess=parse_int, default=Lageart.KEINE_ANGABE
    ),
    ...
    "zulieferung": partial(
        parse_enum, Zulieferung, preprocess=parse_int, default=Zulieferung.KEINE_ANGABE
    ),
    ...
    "bauphase": partial(
        parse_enum, Bauphase, preprocess=parse_int, default=Bauphase.KEINE_ANGABE
    ),
